...
@WebServlet(urlPatterns = { UrlConstant.URL_LOGIN, UrlConstant.URL_LOGOUT })
public class AuthController extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		UserLoginDto userLoginDto = new UserLoginDto(user.getId(), user.getEmail(), user.getPassword(),
				user.getFullname(), user.getAvatar(), role.getName(), role.getDescription());
